...
myst_url_schemes = {
    "gh-issue": {
        "url": "https://github.com/bytewax/bytewax-select-timerange/issues/"
        "{{ path }}#{{ fragment }}",
        "title": "Issue #{{path}}",
        "classes": ["github"],
    },
    "gh-path": {
        "url": f"https://github.com/bytewax/bytewax-select-timerange/blob/{git_id}"
        "#{path}}#",
        "title": "bytewax/bytewax-select-timerange{{ path }}",
        "classes": ["github"],
    },
    "http": None,
    "https": None,
...
# above directory.
autodoc2_packages = ["../src/bytewax/select_timerange"]
